  ...
  <div class="modal-dialog">
    <div class="modal-content">
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" name="name" id="name" value="{{ $product->product_name }}" class="form-control" placeholder="Enter Product Name">
                </div>
              </div>
              ...
              <div class="col-md-6">
                <img src="{{ asset('/assets/images/products/'.$product->image) }}" alt="..." class="img-fluid mx-auto d-block" height="100" width="100">
              </div>
          </div>
      </div>
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary btn-flat">Update Product</button> 
      </div>
      </form>
    </div>
    <!-- /.modal-content -->
